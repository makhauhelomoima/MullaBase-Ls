...
export default function Sell() {
  ...
  async function listProduct(e) {
    ...
    if (error) {
      ...
      setForm({ name: '', description: '', cost_points: '', cash_value: '', category: 'digital' })
      loadData(user.id)
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-200 mb-4">
          ...
          <form onSubmit={listProduct} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                type="number"
                placeholder="Price in points: 200"
                ...
                <div key={p.id} className="border border-gray-100 rounded p-3">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="text-xs text-gray-600">{p.cost_points} pts • M{p.cash_value}</div>
                    </div>
                    <button
